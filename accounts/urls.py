...
from accounts.views import (
    ...
    sales_deposit_collection_create,
    sales_deposit_collection_delete,
    sales_deposit_collection_update,
    sales_deposit_delete,
    sales_deposit_target_detail,
    sales_deposit_target_delete,
    sales_deposit_target_update,
    sales_deposit_targets_export_xlsx,
...
urlpatterns = [
    ...
    path("dashboard/finance/", finance_center, name="finance-center"),
    path("dashboard/finance/export/xlsx/", finance_export_xlsx, name="finance-export-xlsx"),
    path("dashboard/finance/expenses/<int:pk>/edit/", finance_expense_update, name="finance-expense-update"),
    path("dashboard/finance/expenses/<int:pk>/delete/", finance_expense_delete, name="finance-expense-delete"),
    ...
    path("dashboard/sales-deposits/weekly/export/xlsx/", sales_deposit_targets_export_xlsx, name="sales-deposit-targets-export-xlsx"),
    path("dashboard/sales-deposits/weekly/<int:pk>/", sales_deposit_target_detail, name="sales-deposit-target-detail"),
    path("dashboard/sales-deposits/weekly/<int:pk>/edit/", sales_deposit_target_update, name="sales-deposit-target-update"),
    path("dashboard/sales-deposits/weekly/<int:pk>/delete/", sales_deposit_target_delete, name="sales-deposit-target-delete"),
    path("dashboard/sales-deposits/weekly/<int:pk>/collections/new/", sales_deposit_collection_create, name="sales-deposit-collection-create"),
    path("dashboard/sales-deposits/weekly/collections/<int:pk>/edit/", sales_deposit_collection_update, name="sales-deposit-collection-update"),
    path("dashboard/sales-deposits/weekly/collections/<int:pk>/delete/", sales_deposit_collection_delete, name="sales-deposit-collection-delete"),
