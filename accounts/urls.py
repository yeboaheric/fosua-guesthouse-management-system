...
urlpatterns = [
    ...
    path(
        "dashboard/admin/reports/<slug:section>/",
        admin_report_detail,
    ...
    path("dashboard/sales-deposits/<int:pk>/receipt/", sales_deposit_receipt, name="sales-deposit-receipt"),
    path("dashboard/sales-deposits/<int:pk>/receipt/pdf/", sales_deposit_pdf, name="sales-deposit-pdf"),
    ...
    path("dashboard/notifications/read-all/", notification_mark_all_read, name="notification-mark-all-read"),
